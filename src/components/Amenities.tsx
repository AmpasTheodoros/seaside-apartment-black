      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              Netflix app is pre-installed - just press the Netflix button
            </li>
      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              Beach chairs and umbrella are available in the storage closet
            </li>
            <li>Best times to visit: early morning or late afternoon</li>
            <li>
              Beach towels are provided (blue ones in the hallway cabinet)
            </li>
          </ul>
        </div>
      ),
      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              For large vehicles, please use the spots at the end of the lot
            </li>
          </ul>
        </div>
      ),
      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              If water isn't getting hot, check the water heater switch in the
              utility closet
            </li>
      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              Wine glasses and special dinnerware in the cabinet above the sink
            </li>
          </ul>
        </div>
      ),
      ...
      details: (
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              For heating in winter, press the Mode button until the sun icon
              appears
            </li>
    ...
    <section id="amenities" className="py-20">
      <div className="container-custom">
        ...
        <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto">
          Our seaside apartment offers everything you need for a comfortable and
          enjoyable stay. Here are some of the amenities you'll enjoy:
        </p>
            ...
            <Popover key={index}>
              <PopoverTrigger asChild>
                <div className="feature-card flex flex-col items-start cursor-pointer hover:shadow-md transition-all">
                  ...
                  <h3 className="text-xl font-medium mb-2 text-ocean-deepblue">
                    {amenity.title}
                  </h3>
        ...
        <div className="mt-16 bg-white rounded-lg shadow-md p-6 md:p-8">
          <h3 className="text-2xl font-bold mb-4 text-ocean-deepblue">
            What's Included
          </h3>
