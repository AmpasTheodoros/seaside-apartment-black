              ...
              <div className="grid md:grid-cols-2 gap-0">
                <div className="bg-ocean bg-opacity-5 p-8 flex flex-col justify-center">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Say hello to Daniil, your warm and welcoming host who's
                    passionate about sharing the beauty of Chalkidiki with
                    travelers from around the globe.
                  </p>
                  <p className="text-gray-700 leading-relaxed mt-4">
                    With a smile that lights up the room and a heart full of
                    hospitality, Daniil is more than just your host – he's your
                    personal guide to all things local. As a seasoned traveler
                    himself, he understands the importance of feeling at home
                    wherever you go, and he's committed to ensuring that your
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  <span className="font-medium">Check-in:</span> From 15:00 -
                  20:00
                </p>
                <p className="text-gray-700">
