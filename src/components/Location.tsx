...
const Location = () => {
  return (
    <section id="location" className="py-20 bg-sand-light">
      <div className="container-custom">
        <h2 className="section-title text-center">Location</h2>
        <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto">
          Our apartment is perfectly situated to enjoy everything the area has to offer, from pristine beaches to local attractions.
        </p>
        
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-white p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-xl font-bold mb-4 text-ocean-deepblue">Our Address</h3>
              <div className="flex items-start space-x-3">
                <MapPin className="text-coral mt-1 flex-shrink-0" size={20} />
                <p className="text-gray-700">
                  123 Seaside Boulevard<br />
                  Coastal Town, CT 12345<br />
                  United States
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4 text-ocean-deepblue">Getting Here</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Car className="text-ocean mt-1 flex-shrink-0" size={20} />
                  <div>
                    <p className="font-medium">By Car</p>
                    <p className="text-gray-700">30 minutes from Highway 101, free parking on premises</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Bus station 10 minutes walking distance</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Coastal Town Station is 15 minutes by taxi</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-4 text-ocean-deepblue">Nearby Attractions</h3>
